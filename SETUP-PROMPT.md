...
7. Meetings: use only the scheduler I named. If it is topcal, you may fetch slots and complete booking for the invitee (OTP to *their* email). Calendly/Cal.com: put the URL in the reply. Never in email 1.
